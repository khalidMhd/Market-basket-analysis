                    ...
                    <div className='cart shadow bg-white rounded col-sm-4 m-2'>
                        <form className="ibox-body p-3" id="login-form">
                            ...
                            <div className="form-group mb-4">
                                <input className="form-control form-control-line" type="text" name="name" placeholder="Name" />
                            </div>
                            <div className="form-group mb-4">
                                <input className="form-control form-control-line" type="email" name="email" placeholder="Email" />
                            </div>
                            <div className="form-group mb-4">
